...
async def create_reservation(payload: CreateReservation, service: ReservationServiceDep, user_id: CurrentUserIdDep) -> Reservation:
...
async def get_user_reservations(user_id: CurrentUserIdDep, service: ReservationServiceDep) -> Sequence[Reservation]:
