...
async def create_cinema(payload: CreateCinema, cinema_client: CinemaClientDep) -> CinemaRead:
...
async def get_cinema_by_id(cinema_id: int, cinema_client: CinemaClientDep) -> CinemaRead:
...
async def get_cinema_by_name(name: str, cinema_client: CinemaClientDep) -> list[CinemaRead]:
...
async def update_cinema(cinema_id: int, payload: UpdateCinema, cinema_client: CinemaClientDep) -> CinemaRead:
...
async def delete_cinema_by_id(cinema_id: int, cinema_client: CinemaClientDep) -> None:
